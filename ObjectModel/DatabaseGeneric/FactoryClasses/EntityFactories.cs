...
namespace Restaurant.FactoryClasses
{
	...
	{
		private readonly Restaurant.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, Restaurant.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Restaurant.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty BaseEntity objects.</summary>
	[Serializable]
	public partial class BaseEntityFactory : EntityFactoryBase2<BaseEntity> 
	{
		/// <summary>CTor</summary>
		public BaseEntityFactory() : base("BaseEntity", Restaurant.EntityType.BaseEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new BaseEntity(fields); }
	}

	/// <summary>Factory to create new, empty DoughEntity objects.</summary>
	[Serializable]
	public partial class DoughEntityFactory : EntityFactoryBase2<DoughEntity> 
	{
		/// <summary>CTor</summary>
		public DoughEntityFactory() : base("DoughEntity", Restaurant.EntityType.DoughEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new DoughEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public OrderEntityFactory() : base("OrderEntity", Restaurant.EntityType.OrderEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public PizzaEntityFactory() : base("PizzaEntity", Restaurant.EntityType.PizzaEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public PizzaToppingEntityFactory() : base("PizzaToppingEntity", Restaurant.EntityType.PizzaToppingEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new PizzaToppingEntity(fields); }
	}

	/// <summary>Factory to create new, empty SizeEntity objects.</summary>
	[Serializable]
	public partial class SizeEntityFactory : EntityFactoryBase2<SizeEntity> 
	{
		/// <summary>CTor</summary>
		public SizeEntityFactory() : base("SizeEntity", Restaurant.EntityType.SizeEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new SizeEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public ToppingEntityFactory() : base("ToppingEntity", Restaurant.EntityType.ToppingEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Restaurant.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Restaurant.EntityType)))
			{
				var factory = GetFactory((Restaurant.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Restaurant.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Restaurant.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Restaurant.EntityType.BaseEntity:
					return new BaseEntityFactory();
				case Restaurant.EntityType.DoughEntity:
					return new DoughEntityFactory();
				case Restaurant.EntityType.OrderEntity:
					return new OrderEntityFactory();
				case Restaurant.EntityType.PizzaEntity:
					return new PizzaEntityFactory();
				case Restaurant.EntityType.PizzaToppingEntity:
					return new PizzaToppingEntityFactory();
				case Restaurant.EntityType.SizeEntity:
					return new SizeEntityFactory();
				case Restaurant.EntityType.ToppingEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Restaurant.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Restaurant.EntityType)Enum.Parse(typeof(Restaurant.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Restaurant.EntityType)Enum.Parse(typeof(Restaurant.EntityType), leftOperandEntityName, false), joinType, (Restaurant.EntityType)Enum.Parse(typeof(Restaurant.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Restaurant.EntityType)Enum.Parse(typeof(Restaurant.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Restaurant.EntityType)entityTypeValue); }
